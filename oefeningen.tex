...
\begin{oef}
  ...
  \item  Na $n$ zwarte ballen zijn er $10+n$ zwarte ballen en nog steeds $5$ rode ballen.
    ...
    \[ \lim_{n \rightarrow +\infty}P(Z_{n+1}|Z_{1} \cap Z_{2} \cap \dotsb \cap Z_{n}) = \frac{10+n}{15+n} = 1 \]
  \item 
    \[
    \begin{array}{rl}
      \frac{10+n}{15+n}
      &= P(Z_{n+1}|Z_{1} \cap Z_{2} \cap \dotsb \cap Z_{n})\\
      &= P(Z_{1} \cap Z_{2} \cap \dotsb \cap Z_{n} \cap Z_{n+1})\\
    \end{array}
    \]
    \[
    \begin{array}{rl}
      ...
      &= \frac{P(Z_{1})P(Z_{2}|Z_{1})P(Z_{3}|Z_{2}\cap Z_{1}) \cdot \dotsb \cdot P(Z_{n+1}|Z_{1} \cap Z_{2} \cap \dotsb \cap Z_{n}) }{P(Z_{2} \cap Z_{3} \cap \dotsb \cap Z_{n+1})}\\
      &= \frac{P(Z_{2}|Z_{1})P(Z_{3}|Z_{2}\cap Z_{1}) \cdot \dotsb \cdot P(Z_{n+1}|Z_{1} \cap Z_{2} \cap \dotsb \cap Z_{n}) P(Z_{1})}{P(Z_{2} \cap Z_{3} \cap \dotsb \cap Z_{n+1})}\\
      &= \frac{\prod_{i=1}^{n}\frac{10+n}{15+n} }{P(Z_{2})P(Z_{3}|Z_{2})P(Z_{4}|Z_{3}\cap Z_{2}) \cdot \dotsb \cdot P(Z_{n+1}|Z_{2} \cap Z_{3} \cap \dotsb \cap Z_{n})}\\
      &= \frac{\prod_{i=1}^{n}\frac{10+n}{15+n} }{\prod_{i=2}^{n}P(Z_{i+1}|Z_{2} \cap Z_{3} \cap \dotsb \cap Z_{i})}\\
      &= \frac{\prod_{i=1}^{n}\frac{10+n}{15+n} }{\prod_{i=2}^{n}P(Z_{i+1}|Z_{2} \cap Z_{3} \cap \dotsb \cap Z_{i})P(Z_{1} \cup \overline{Z}_{1})}\\
      &= \frac{\prod_{i=1}^{n}\frac{10+n}{15+n} }{\prod_{i=2}^{n}P(Z_{i+1}|Z_{2} \cap Z_{3} \cap \dotsb \cap Z_{i})(P(Z_{1}) +P(\overline{Z}_{1}))}\\
    \end{array}
    \]
  \end{itemize}
\end{oef}
