...
\begin{st}
  \label{st:eerste-wet-van-de-morgan}
...
\begin{st}
  \label{st:tweede-wet-van-de-morgan}
...
\begin{st}
  \label{st:verschil-verzamelingen-is-doorsnede-complement}
...
\begin{st}
  \label{st:symmetrisch-verchil-twee-verschillen}
...
\begin{st}
  \label{st:symmetrisch-verchil-enkelvoudig-verchil.}
  Het symmetrisch verschil van twee verzamelingen kan worden herschreven als een enkelvoudig verchil.
