...
\formularium{Binomiaal verdeling}{$P(X=k) = \binom{n}{k}p^{k}(1-p)^{n-k}$}
...
\TODO{Binomiaal: $n\ge30$}
\TODO{Binomiaal: $n\ge30$, $np \ge 5$ en $nq \ge 5$}
\TODO{Binomiaal: $n\ge30$, $np < 5$}
\TODO{Binomiaal: $n\ge30$, $nq < 5$}
\TODO{Poisson: $\alpha > 10$, $\alpha \le 10$}
