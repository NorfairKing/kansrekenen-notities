...
\begin{de}
  ...
  Een re\"ee functie $X$ als volgt noemen we een \term{stochastische veranderlijke}, een \term{stochastische variabele}, een \term{stochastiek}, een \term{toevalsvariabele} of een \term{random variabele}.
